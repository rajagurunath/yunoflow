    ...
    <header className="sticky top-0 z-50 border-b border-vline bg-paper/85 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center gap-8 px-6">
        ...
        <nav className="hidden flex-1 items-center gap-7 md:flex">
          ...
          <a href={DEMO_RETIRED ? API_REFERENCE_URL : API_DOCS_URL} target="_blank" rel="noreferrer" className={`${link} inline-flex items-center gap-1`}>API <span className="text-[10px] text-inkdim">↗</span></a>
    ...
    <footer className="border-t border-vline bg-sand">
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-6 py-14 md:grid-cols-5">
        ...
        <div className={col}>
          ...
          <a className={link} href={DEMO_RETIRED ? API_REFERENCE_URL : API_DOCS_URL} target="_blank" rel="noreferrer">API reference (OpenAPI) ↗</a>
        </div>
        <div className={col}>
